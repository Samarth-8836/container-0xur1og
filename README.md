...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0xur1og.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0xur1og.containers.anotherwebservice.com/
...
```
git clone git@github.com:Samarth-8836/container-0xur1og.git
cd container-0xur1og
```
...
```
docker attach container-0xur1og
```
